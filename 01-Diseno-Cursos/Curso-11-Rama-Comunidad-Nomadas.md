# Diseño del Curso 11 — 🧗 Rama Comunidad (Nómadas Scout)

**Línea:** Programa de Jóvenes · **Nivel:** 2 (Profundización por rama y práctica pedagógica) · **Posición:** cuarto curso de rama construido, después de Manada (8), Familia (9) y Tropa (10).

> La rama de la adolescencia tardía: **15 a 17 años**. El Modelo de Aplicación distingue tres cosas que en el habla diaria se mezclan (p. 106): la **Sección** es el tramo etario (15 a 17), la **Rama** es su identidad educativa (**Nómadas Scout**) y la **Unidad** es el grupo concreto donde se vive el programa (**Comunidad**). El título del curso sigue al plan de línea, que la nombra «Rama Comunidad (Nómadas)»; dentro del curso la distinción se enseña bien.

---

## 0. La situación de fuentes

A diferencia de Tropa, **Comunidad sí tiene Guía de Dirigente 2026**, así que aquí la fuente angular es la normal de la línea.

| Fuente | Qué cubre | Peso |
|---|---|---|
| **Guía para el Dirigente de Comunidad de Nómadas Scout** (DNPJ 2026, 48 pp., 12 capítulos) | Todo lo propio de la rama: integrantes, Método, Ley y Promesa, Aprender Haciendo, Sistema de Equipos, Marco Simbólico, Naturaleza, Progresión, Involucramiento Comunitario, relación adulto-joven, Ciclo de Programa, administración | **Angular** |
| **Modelo de Aplicación 2026** (109 pp.) | Sección/Rama/Unidad, identidad de la rama, territorio, ratio de adultos | Manda en la estructura de secciones y ramas |
| **PNPJ 2024** | Marco de política | Textos oficiales |
| **Guía de Buenas Prácticas para Jefes de Tropa** (DNPJ 2026) | El otro lado de la Travesía | Se cita solo para la transición de entrada |
| ~~Guía para el Dirigente de Comunidad **2018**~~ · ~~Manual Interamericano COMUNIDAD~~ | — | **Referencia histórica. NO se citan como vigentes.** |
...
1. **El sexto Rumbo está mal titulado en la tabla del perfil de egreso.** La tabla de competencias repite el encabezado «RUMBO DEL PUENTE - SOCIABILIDAD» dos veces (pp. 29–30), pero el segundo bloque contiene competencias de **Espiritualidad** (Respeto por la vida, Crecimiento Espiritual, Trascendencia). La lista de insignias lo nombra bien: **Espiritualidad — Rumbo del Fuego** (p. 35). *Se enseña el nombre de la lista*, que es el que concuerda con las seis áreas de crecimiento del Modelo.
2. **La duración del Ciclo de Programa se dice de dos maneras en la misma página.** «Generalmente dura entre cuatro y seis meses» y, doce líneas después, «puede ir de tres a seis meses» (p. 44). *Se enseña **de tres a seis meses**, que es el rango más amplio y el que la Guía repite al explicar quién lo decide* — los propios jóvenes a través del organismo de gobierno.
3. **El Diario de Ruta no está en el índice de su propia Guía.** El capítulo 12 describe cinco herramientas (p. 47); el índice lista cuatro. *Se enseñan las cinco*: la que falta es justamente la herramienta de seguimiento de la progresión.
...
| Campo | Valor |
|---|---|
| `courseId` | `rama-comunidad-nomadas` |
...
6. **Acompañar un proyecto de involucramiento comunitario** en sus seis momentos, y reconocer la diferencia entre servir *a* la comunidad y construir *con* la comunidad.
7. **Leer la progresión**: seis Rumbos, tres niveles de desarrollo y cuatro fases, y elegir su propio rol —apoyar, acompañar o enlazar— según el nivel en que esté el joven.
8. **Acompañar las dos transiciones**: la llegada desde la Tropa y la salida al Clan, con sus insignias y sus tres pasos.
...
**Protagonista:** **Andrés**, el mismo del Curso 10 — que allí cumplía 14 y empezaba su Travesía. El Curso 10 cierra diciendo que el curso de Comunidad «todavía está por construirse». Ahora existe, y recoge a Andrés donde lo dejó.
...
| `achievement-6` | 7 | Leo los Rumbos |
| `achievement-7` | **−1** | Dirigente de Comunidad |

> El logro final vuelve a declararse con `unlockOnModule: -1`. Desde el **ADR-046** eso ya funciona: el motor lo enciende barriendo la convención, no por su id.

---

## 6. Conexiones cross-course

- **Curso 10 (Tropa)** — entrada directa: Andrés y su Travesía. El Curso 10 dice que este curso «todavía está por construirse»; **al publicarse este, esa frase queda desactualizada y hay que barrerla** (lección del ADR-044: un curso publicado no se actualiza solo).
- **Curso 12 (Clan)** — salida: los tres pasos de la transición y la canoa como símbolo Rover, que este curso nombra sin desarrollar porque es del siguiente.
- **Curso 5 (Método Scout)** — los ocho elementos, aquí aterrizados a la rama. Cuidado con el nombre del elemento: la Guía lo llama «Vida en Pequeños Grupos» (p. 9) y el Curso 5 lo llama «Sistema de Equipos».
- **Curso 6 (PNPJ y Modelo)** — las seis áreas de crecimiento, que aquí toman nombre de Rumbo; las tres etapas y el rol triple Apoyar/Acompañar/Enlazar.
- **Curso 25 (A Salvo del Peligro aplicado al Programa)** y **línea Políticas Transversales, Curso 03** — se enlaza y **no se reexplica** la conducta ante una revelación (ADR-038).

---

## 7. Validación contra el marco metodológico

- **Andragogía (Knowles):** cada lección cierra en algo aplicable el sábado siguiente, no en una definición.
- **Patrón anti-definición:** ninguna lección abre definiendo; abren con una situación de Comunidad y la definición llega cuando ya hace falta.
- **Microlearning:** 7 lecciones de contenido, cada una con su quiz de 2 preguntas y umbral del 70 %.
- **Ausubel:** el andamiaje es explícito — lo de Tropa se nombra para apoyarse en ello, no para repetirlo.
- **Bandura:** los ejemplos son de conducta del adulto observable (qué dices en un Congreso cuando no estás de acuerdo), no de rasgos.
- **Quizzes:** se miden las tres compuertas de paridad que vigila el build —extremo de longitud, oveja negra y sesgo de longitud— y se corrigen **ajustando distractores**, nunca alargando la correcta.
