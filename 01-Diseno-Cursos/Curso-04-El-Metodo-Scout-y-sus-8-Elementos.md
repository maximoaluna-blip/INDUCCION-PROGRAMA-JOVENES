...
| Campo | Valor |
|---|---|
| `courseId` | `metodo-scout-8-elementos` |
...
1. **Define** el Método Scout como un sistema de autoeducación progresiva basado en la interacción de 8 elementos interdependientes (no una lista de técnicas separadas).
...
5. **Aplica** las 4 Dinámicas del Escultismo (Objetivos Educativos, Oportunidades de Aprendizaje, Vida de Grupo, Estructura y Funcionamiento) para evaluar la calidad del Programa de su unidad.
...
> **"El Método Scout no es una lista de 8 técnicas que puedas mezclar y combinar. Es un sistema. Si quitas uno solo, lo que queda ya no es el Método. Y si crees que solo aplicas 5 o 6 'porque tu rama no necesita el resto', no estás haciendo escultismo."**

Este hook se enuncia en la lección 2 y se repite cada vez que se introduce un nuevo elemento. Su función es contradecir la tentación frecuente del dirigente nuevo de "elegir los elementos que más le gustan" en lugar de integrar el sistema completo.
...
|---|---|---|---|---|
| 1 | 👋 Bienvenida | 3 min | Vas a aprender el sistema con el que el Movimiento educa. | Empecé el camino |
| 2 | 🧭 El Método como sistema | 5 min | 8 elementos interdependientes, no una lista. | Veo el sistema |
| 3 | 📜 Elementos 1–2: Promesa, Ley y Aprender Haciendo | 6 min | La ética y la práctica. | Ética + práctica |
| 4 | 🌱 Elementos 3–4: Progresión Personal y Sistema de Equipos | 6 min | Crecimiento individual y vida de pequeño grupo. | Crezco con otros |
| 5 | 💗 Elementos 5–6: Apoyo del Adulto y Marco Simbólico | 6 min | El acompañante y el imaginario. | Apoyo + imaginación |
| 6 | 🌳 Elementos 7–8: Naturaleza y Participación en la Comunidad | 6 min | El laboratorio y el servicio. | Naturaleza + ciudadanía |
...
**Idea central:** Vas a aprender el sistema con el que el Movimiento educa.
...
4. **`list`** — Las 7 ideas (lecciones 2 a 8):
    - Por qué el Método es un sistema y no una lista.
    - Los 8 elementos en 4 parejas (2-2-2-2).
    - Las 4 Dinámicas del Escultismo que muestran el Método en acción.
    - Cómo planear una reunión real integrando los 8 elementos.
5. **`mission-box`** — _"Si terminas este curso sin un plan concreto para tu próxima reunión, lo perdimos. Asegúrate de llegar a la Lección 8 con energía para hacer el ejercicio."_

**Reflexión:** ninguna.
**Quiz:** ninguno.
**Logro:** "Empecé el camino".

---

### 4.3 Lección 2 — 🧭 El Método como sistema (5 min)

**Idea central:** 8 elementos interdependientes, no una lista.

**Secciones (en orden):**

1. **`info-box`** — Idea central de la lección.
2. **`paragraph`** — **Anti-definición**: _"Si abres The Scout Method de la OMMS vas a leer 'sistema de autoeducación progresiva basado en la interacción de elementos igualmente importantes que funcionan como un sistema cohesivo'. Es exacto, lo adoptó la 41ª Conferencia Scout Mundial en 2017 y la PNPJ 2024 lo asumió tal cual. Y, si nunca has hecho un curso así, es difícil de digerir en frío. Vamos a llegar a esa frase, pero por el camino aterrizado."_
3. **`policy-quote`** — Cita oficial:
    ...
    - `source`: "The Scout Method, OMMS 2019 (Resolución 41 ª Conferencia Scout Mundial 2017-04), p. 14."
    - `label`: "📋 Ver la definición oficial"
4. **`info-box`** — **Reformulación accesible**: _"En palabras simples: el Método Scout es la forma en que el Movimiento educa. Y esa forma no es una lista de técnicas sueltas que tú puedas escoger según el día — es un sistema de 8 piezas que se sostienen mutuamente. Quitas una, se cae todo. La definición oficial dice eso mismo, en lenguaje doctrinal."_
...
8. **`list`** — Los 8 elementos en orden oficial:
    ...
    - **Aprender Haciendo** — la experiencia como motor del aprendizaje.
    - **Progresión Personal** — el camino individual de crecimiento.
    - **Sistema de Equipos** — los pequeños grupos donde se vive el Movimiento.
    - **Apoyo del Adulto** — el rol del dirigente como facilitador.
    - **Marco Simbólico** — el universo narrativo de cada rama.
    - **Naturaleza** — el entorno educativo privilegiado.
    - **Participación en la Comunidad** — el servicio y la ciudadanía activa.
9. **`info-box`** — Cita de B-P: _"Para los que tienen ojos para ver y oídos para oír, el bosque es a la vez un laboratorio, un club y un templo. (B-P, Rovering to Success)"_

**Reflexión:** _"De los 8 elementos, ¿cuáles ya reconoces que se aplican en tu unidad y cuáles te parecen extraños o ausentes?"_
...
>
> a) _Solo se aplica el elemento que más se ajusta a la rama._
> b) _Ningún elemento vale más que los otros; el sistema requiere los 8._  ✅
> c) _Cada rama elige cuál de los 8 trabajar cada año._

**Logro:** "Veo el sistema".

---

### 4.4 Lección 3 — 📜 Elementos 1–2: Promesa, Ley y Aprender Haciendo (6 min)

**Idea central:** La ética y la práctica.

**Secciones (en orden):**

1. **`info-box`** — Idea central de la lección.
2. **`heading` (nivel 3)** — _"Elemento 1 — Promesa y Ley"_
3. **`paragraph`** — _"La Promesa es la decisión voluntaria del joven de adherirse al código de vida del Movimiento. La Ley es ese código, formulado en términos positivos y progresivos según la rama. Promesa y Ley son **una pareja**: la Promesa sin Ley es palabra vacía; la Ley sin Promesa es regla externa."_
4. **`policy-quote`** — Cita textual de B-P:
    - `text`: _"El honor de un Scout es ser digno de confianza."_
    - `source`: "Robert Baden-Powell."
    - `label`: "📋 La cita central de la Promesa"
5. **`paragraph`** — _"En cada rama, la Promesa y la Ley se formulan con el lenguaje propio de la edad: la Ley del Cachorro, la Ley del Lobato, la Ley Scout, la Ley Nómada, la Ley Rover. Lo importante: en todas ellas, el joven dice 'yo prometo' libremente. No 'yo obedezco'. No 'yo cumplo porque me obligan'. La voluntariedad es la condición."_
6. **`heading` (nivel 3)** — _"Elemento 2 — Aprender Haciendo"_
...
**Reflexión:** _"Recuerda una situación reciente donde, por la prisa o por evitar el error, **hiciste por** un protagonista lo que él hubiera podido hacer solo o con apoyo. Escribe brevemente: ¿qué pasó? ¿Qué hubieras hecho distinto sabiendo lo que sabes ahora?"_

**Quiz (2 preguntas):**

> **P1.** La Promesa y la Ley son una pareja porque…
>
> a) _Siempre se dicen una después de la otra en las ceremonias._
...
### 4.5 Lección 4 — 🌱 Elementos 3–4: Progresión Personal y Sistema de Equipos (6 min)

**Idea central:** Crecimiento individual y vida de pequeño grupo.
...
8. **`paragraph`** — _"En la Tropa, el Sistema de Patrullas es **el corazón del Método**, según B-P. Una patrulla bien constituida lidera sus propias actividades, planea su comida, organiza su rincón, resuelve sus conflictos. El Jefe de Tropa no manda a las patrullas; trabaja con los Guías de Patrulla."_
...
> **P1.** La Progresión Personal en el Método Scout…
>
> a) _Es una competencia donde se reconoce al que más avanza._
...
### 4.6 Lección 5 — 💗 Elementos 5–6: Apoyo del Adulto y Marco Simbólico (6 min)

**Idea central:** El acompañante y el imaginario.
...
5. **`policy-quote`** — Cita de B-P sobre el rol:
    ...
    - `source`: "Robert Baden-Powell, citado por la OMMS."
...
8. **`method-grid`** — Marcos simbólicos por rama:
    ...
    - ⚜️ **Tropa** → Marco propio Scout: Patrulla, Honor, Hermandad.
    - 🧗 **Comunidad** → Aventura y Ciudadanía.
    - 🏔️ **Clan** → Rovering propio: Vigilia, Peregrinaje, Partida.
9. **`info-box`** — _"Un dirigente que ignora o ridiculiza el Marco Simbólico ('eso es de niños'), está cortando el cable principal por el que la rama transmite sus valores. El símbolo es el método. Tómalo en serio aunque te dé pena."_
...
> c) _La Aventura y la Ciudadanía._

**Logro:** "Apoyo + imaginación".

---

### 4.7 Lección 6 — 🌳 Elementos 7–8: Naturaleza y Participación en la Comunidad (6 min)

**Idea central:** El laboratorio y el servicio.

**Secciones (en orden):**

1. **`info-box`** — Idea central de la lección.
2. **`heading` (nivel 3)** — _"Elemento 7 — Naturaleza"_
3. **`paragraph`** — _"La Naturaleza es el entorno educativo privilegiado del Movimiento. No es decoración del fin de semana ni un lujo de los grupos urbanos. Es el espacio donde los otros 7 elementos cobran intensidad: en la naturaleza, la patrulla se vuelve indispensable; la Promesa toma cuerpo; el Aprender Haciendo se vuelve necesidad; el Marco Simbólico encuentra su escenario natural."_
4. **`policy-quote`** — La cita célebre de B-P:
...
**Reflexión:** _"En el último año, tu unidad ¿cuánto tiempo pasó en naturaleza real (campo, monte, río, bosque)? ¿Y cuántos proyectos hicieron CON la comunidad, no solo PARA la comunidad? Sé honesto."_

**Quiz (2 preguntas):**

> **P1.** Según B-P, el bosque es para los Scouts…
>
> a) _Un lugar de entretenimiento de fin de semana._
> b) _Un laboratorio, un club y un templo a la vez._  ✅
> c) _Un escenario opcional según la región del grupo._

> **P2.** La Participación en la Comunidad, según The Scout Method OMMS 2019, no consiste solo en…
>
> a) _Hacer cosas PARA los demás; consiste en hacer cosas CON los demás (implicación)._  ✅
> b) _Realizar campañas anuales de donaciones._
> c) _Asistir a eventos comunitarios cuando hay invitación._

**Logro:** "Naturaleza + ciudadanía".

---

### 4.8 Lección 7 — 🎯 Las 4 Dinámicas del Escultismo en acción (4 min)

**Idea central:** Cómo se ven los 8 elementos juntos.

**Secciones (en orden):**

1. **`info-box`** — Idea central de la lección.
2. **`paragraph`** — Apertura: _"Los 8 elementos no se aplican uno por uno como una checklist. Se viven simultáneamente. The Scout Method (OMMS 2019, pp. 28-31) llama a estas manifestaciones simultáneas **'las 4 Dinámicas del Escultismo'**. Son la forma en que el Método se hace visible en la vida real de la unidad."_
3. **`heading` (nivel 3)** — _"Las 4 Dinámicas"_
4. **`method-grid`** — Las 4 Dinámicas:
    - 🎯 **Objetivos Educativos** — el norte del crecimiento del protagonista (las competencias terminales e intermedias por rama).
...
> **P1.** Las 4 Dinámicas del Escultismo son…
>
> a) _Promesa, Ley, Patrulla, Naturaleza._
...
### 4.9 Lección 8 — ✍️ Mi próxima reunión con los 8 elementos (4 min)

**Idea central:** Planear una reunión real integrando todo.

**Secciones (en orden):**

1. **`info-box`** — Idea central de la lección.
2. **`paragraph`** — Apertura: _"Vas a hacer el ejercicio más importante del Nivel 1. Piensa en la próxima reunión de tu unidad (o de la unidad que vas a acompañar). Vamos a ver qué tan bien integra los 8 elementos."_
3. **`heading` (nivel 3)** — _"Checklist de los 8 elementos para tu próxima reunión"_
4. **`list`** — 8 preguntas, una por elemento:
    - **Promesa y Ley** — ¿Hay un momento de la reunión donde se mencione, se viva o se reconozca la Promesa o algún punto de la Ley?
    - **Aprender Haciendo** — ¿Los protagonistas van a **hacer** algo, o solo van a **escuchar y mirar**?
    - **Progresión Personal** — ¿La reunión contempla observar o registrar avances de algún protagonista en alguna área?
    ...
    - **Naturaleza** — ¿La reunión ocurre o se conecta con un espacio natural (parque, cerro, jardín, plaza con árboles)?
    - **Participación en la Comunidad** — ¿Hay algún hilo que vincule la reunión con el territorio (familia, barrio, escuela, comunidad)?
5. **`paragraph`** — _"Si respondiste 'no' o 'no sé' a más de 3 de las 8: tu próxima reunión necesita ajustes. Si respondiste 'sí' a las 8: vas en camino del Método; sigue cuidando que el sistema se mantenga."_
6. **`heading` (nivel 3)** — _"Mi ajuste de esta semana"_
...
> **P1.** Si una reunión cumple solo 3 de los 8 elementos del Método, lo más correcto es…
>
> a) _Está perfecto; cada rama elige los elementos que más le sirven._
> b) _Hay que ajustar la próxima reunión para volver a integrar el sistema completo._  ✅
> c) _Cambiar de método y aplicar uno escolar._

> **P2.** El Método se aprende…
>
> a) _Estudiando manuales hasta saberlo de memoria antes de aplicarlo._
> b) _Aplicándolo, ajustando reunión a reunión, sin perder el sistema completo._  ✅
> c) _Esperando a tener experiencia para empezar a usarlo._

**Logro al completar:** "Practicante del Método" (logro final, `unlockOnModule: -1`).
...
| `achievement-2` | Veo el sistema | 🧭 | Al completar Lección 2 |
| `achievement-3` | Ética + práctica | 📜 | Al completar Lección 3 |
| `achievement-4` | Crezco con otros | 🌱 | Al completar Lección 4 |
| `achievement-5` | Apoyo + imaginación | 💗 | Al completar Lección 5 |
| `achievement-6` | Naturaleza + ciudadanía | 🌳 | Al completar Lección 6 |
| `achievement-7` | Veo el método en vivo | 🎯 | Al completar Lección 7 |
| `achievement-final` | Practicante del Método | 🧭✨ | Al completar el curso (`unlockOnModule: -1`) |

(Excepción al patrón estándar de 4-6 logros: este curso tiene 8 lecciones de contenido por la centralidad doctrinal, justificando 7 + 1 final.)
...
| Tipo | Lecciones |
|---|---|
| `info-box` | L1, L2, L3, L4, L5, L6, L7, L8 (todas) |
| `paragraph` | Todas |
| `heading` (nivel 3) | L1, L2, L3, L4, L5, L6, L7, L8 |
| `list` | L1, L2, L8 |
| `method-grid` | L2 (4 palabras clave), L4 (5 ramas), L5 (5 marcos simbólicos), L7 (4 Dinámicas) |
| `mission-box` | L1, L8 |
| `policy-quote` | L2, L3 (2), L5, L6 (2) |
| `reflection` | L2, L3, L4, L5, L6, L7, L8 |
| `quiz` | L2, L3, L4, L5, L6, L7, L8 |

**No requiere ningún tipo de sección nuevo.**
...
|---|---|---|---|
| Diagrama "Los 8 elementos como sistema" | SVG | Por crear | Visualización circular o de red mostrando interdependencia. Crítico para L2. |
| Imagen de portada | PNG | Por crear | Brújula sobre paisaje natural — color #00838F. |
| Iconos por elemento (8) | Emoji | Listo | Se renderizan con emoji. |

**Decisión sugerida:** lanzar con el diagrama de los 8 elementos como infografía descargable en L2. Sin video en primera versión.
...
| Citas oficiales plegables | ✅ 6 citas (OMMS 2019 y B-P) |
...
| Conexión cross-course | ✅ con Cursos 1, 2, 3, 5, 6, 24 y DI 8 |
...
2. **Diseñar el diagrama "Los 8 elementos como sistema"** (clave para L2).
3. **Generar el JSON** del curso siguiendo `course-schema.json`.
4. **Generar HTML** con `node build-course.js metodo-scout-8-elementos`.
5. **Generar preview PDF** y revisar.
6. **Pilotar** junto a los Cursos 1–3 con los mismos 5–10 dirigentes.

---

_Documento de diseño del Curso 4, versión inicial — 28 de mayo de 2026. Fuente angular: "The Scout Method", OMMS Oficina Scout Mundial 2019 (Resolución 41 ª Conferencia Scout Mundial 2017-04). Validado contra el marco metodológico de la plataforma y la PNPJ 2024 / Modelo de Aplicación 2026._
